...
<div class="row">
 ...
 <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="sexe" value="ذكر"> ذكر </span>

            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="sexe" value="أنثى"> أنثى </span>
 ...
 <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="situation_fa" value="متزوج"> متزوج </span>

            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="situation_fa" value="أعزب"> أعزب </span>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control" id="fonction_first" name="fonction_first" 
	...
	<div class="form-group">
	  ...
	  <label for="fonction_grade_first" class="col-sm-3 control-label"> تاريخ أول تعين </label>

	  <div class="col-sm-4">

	    <input type="date" class="form-control" id="fonction_grade_first" name="fonction_grade_first" 
	...
	<div class="form-group">
	  ...
	  <label for="fonction_actuel" class="col-sm-3 control-label"> الوظيفة الحالية </label>

	  <div class="col-sm-4">

	    <input type="text" class="form-control" id="fonction_actuel" name="fonction_actuel" 
	...
	<div class="form-group">
	  ...
	  <label for="date_fonction_actuel" class="col-sm-3 control-label"> تاريخ الوظيفة الحالية </label>

	  <div class="col-sm-4">

	    <input type="text" class="form-control span2 datepicker" id="date_fonction_actuel" name="date_fonction_actuel" value="<?php echo set_value("date_fonction_actuel","2020-12-14"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="date" class="form-control span2 datepicker" id="date_grade" name="date_grade" value="<?php echo set_value("date_grade","2020-12-14"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <select class="form-control select2" name="wilaya_fonction" id="wilaya_fonction">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("etablissement"); ?>"
      ...
      <!-- ...................................................................... -->
            ...
            <div class="row jumbotron">
                ...
                <div class="col-md-12">
                            ...
                            <fieldset><legend>الشهادات والمؤهلات</legend>
                             
                        <!-- Text input-->
                        <table style="width: 100%" class="table">
                            <thead><tr><th>رقم</th><th>من</th><th>إلى</th><th>لشهادة</th><th>From</th><th>To</th><th>Ticket No.</th><th>Amount</th></tr></thead>
                            <tbody id="table-details"><tr id="row1" class="jdr1">
                                    ...
                                    <td><input type="text" required="" class="form-control input-sm datepicker" placeholder="تاريخ بداية" name="jdate[]"></td>
