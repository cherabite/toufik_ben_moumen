...
{
    public $v_fields=array('nom', 'prenom', 'wilaya_n', 'sexe', 'situation_fa', 'nb_enfant', 'adresse', 'tel', 'email', 'image', 'fonction_first', 'fonction_grade_first', 'fonction_actuel', 'date_fonction_actuel', 'grade', 'date_grade', 'wilaya_fonction', 'etablissement', 'num_emp');
